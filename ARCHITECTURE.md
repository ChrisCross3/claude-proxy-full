...
| `src/trace/*` | OTLP-Builder, SQLite-Store, Redaktor, Exporter |
...
33 Test-Files unter `src/__tests__/` (Node-`node:test`). Test-Bilanz auf der Hermes-VM (`npm test`): **429 Tests / 427 pass / 2 skip / 0 fail**.
