 ...
 *
 * Der Proxy wird Hermes gegenueber als OpenRouter-kompatibler Endpoint
 * registriert (base_url enthaelt "openrouter"). Hermes' OpenRouter-Profil
...
export function normalizeOpenRouterRequest(req: AnyRecord): void {
  ...
  // Hermes sends reasoning as a top-level field (OpenAI-Responses-style);
